...
![[cdv_photo_1764239347_20251127112907.jpg]]
...
![[cdv_photo_1764239313_20251127112833.jpg]]
---
...
**Usar `Circular Linked List` en Java**
...
class CircularNode {  
    ...
    static void main() {  
        ...
        // Recorrer e imprimir UNA VUELTA al círculo        CircularNode current = head;  
        if (head != null) {  
            do {  
                System.out.println(current.data);  
                current = current.next;  
        ...
        /**  
         * Insertar al inicio (push_front) valor 5         * Resultado esperado: [5 -> 10 -> 20 -> 30 -> vuelve a 5]         */        CircularNode newNode = new CircularNode(5);  
        ...
        /**  
         * Eliminar el primer nodo (pop_front)         * Casos:         *  - lista con un solo nodo         *  - lista con varios nodos         */        if (head != null) {  
        ...
        /**  
         * Insertar 15 después del nodo con valor 10         * Resultado final esperado (si existía 10):         * [5 -> 10 -> 15 -> 20 -> 30 -> vuelve a 5]         */        if (head != null) {  
            current = head;  
            do {  
                if (current.data == 10) {  
